...
export function CreatePage() {
  ...
  async function create(nextStyle = style) {
    if (!user) { setError(tr('Sign in to create outfits from your wardrobe.', 'Войди, чтобы создавать образы из своего гардероба.')); return; }
    setStyle(nextStyle);
